  ...
  release:
    ...
    - name: 📦 Prepare Release Assets
      run: |
        ...
        cp PressureVesselCalculator-windows/PressureVesselCalculator.exe release-assets/PressureVesselCalculator-Windows.exe
        cp PressureVesselCalculator-macos/PressureVesselCalculator release-assets/PressureVesselCalculator-macOS
        cp PressureVesselCalculator-linux/PressureVesselCalculator release-assets/PressureVesselCalculator-Linux
